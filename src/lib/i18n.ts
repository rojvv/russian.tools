...
export const messages = {
  en: {
    ...
    homeDescription:
      "Free online Russian language tools: add stress marks to text, conjugate verbs, and decline nouns and adjectives in all six cases.",
  ...
  ru: {
    ...
    homeDescription:
      "Бесплатные инструменты для русского языка: расстановка ударений, спряжение глаголов и склонение существительных и прилагательных по всем шести падежам.",
